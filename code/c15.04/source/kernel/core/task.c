...
void task_first_init (void) {
    ...
    task_init(&task_manager.init_task, "init task", 0, first_start, first_start + alloc_size);
    task_manager.init_task.heap_start = (uint32_t)&e_first_task;  // 这里不对
    task_manager.init_task.heap_end = task_manager.init_task.heap_start;
